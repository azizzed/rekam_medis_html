...
?>
		    ...
		    <tr valign="baseline">
		      ...
		      <td><select class="span9" name="diagnosa">
		        ...
		        <option value="terjangkit" <?php if (!(strcmp("terjangkit", htmlentities($row_editrekam['diagnosa'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Terjangkit</option>
		        <option value="stadium" <?php if (!(strcmp("stadium", htmlentities($row_editrekam['diagnosa'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Stadium</option>
		        </select></td>
	        </tr>
		    <tr valign="baseline">
