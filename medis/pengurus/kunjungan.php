...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO kunjungan (tgl_kunjungan, no_pasien, kd_poli, jam_kunjungan) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['tgl_kunjungan'], "date"),
                       GetSQLValueString($_POST['no_pasien'], "int"),
                       GetSQLValueString($_POST['kd_poli'], "int"),
                       GetSQLValueString($_POST['jam_kunjungan'], "date"));
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="text" style="display:none" name="jam_kunjungan" value="<?php echo date("g:i a")?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
