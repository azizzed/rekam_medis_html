...
$query_tampil = "SELECT * FROM kunjungan";
...
<?php include("navbar.php"); ?>
    ...
    <div class='well' fixed center;'>
		...
		<table style='margin-top:10px;background:white' class="table table-bordered table-striped table-hover">
		  ...
		  <?php do { ?>
		    <tr>
		      <td><?php echo $row_tampil['tgl_kunjungan']; ?></td>
		      <td><?php echo $row_tampil['no_pasien']; ?></td>
		      <td><?php echo $row_tampil['kd_poli']; ?></td>
		      <td><?php echo $row_tampil['jam_kunjungan']; ?></td>
		      <td><?php echo $row_tampil['kd_kunjungan']; ?></td>
		      <td>
              
              <div class='btn-group'>
              <a href="hapuskunjungan.php?kd_kunjungan=<?php echo $row_tampil['kd_kunjungan']; ?>"class="btn btn-mini btn-danger tipsy-kiri-atas" title="Hapus Data Ini"><i class="icon-remove icon-white"></i></a> 
              <a href="formeditkun.php?kd_kunjungan=<?php echo $row_tampil['kd_kunjungan']; ?>" class="btn btn-mini btn-info tipsy-kiri-atas" title='Edit Data ini'> <i class="icon-edit icon-white"></i> </a></div>
              </td>
	      </tr>
