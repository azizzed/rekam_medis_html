...
$query_tampil = "SELECT * FROM laboratorium";
...
<?php include("navbar.php"); ?>
    ...
    <div class='well' fixed center;'>
		...
		<a href='labbaru.php' class='btn btn-primary'><i class='icon icon-white icon-plus'></i> Tambah Laboratorium</a>
		<table style='margin-top:10px;background:white' class="table table-bordered table-striped table-hover">
		  ...
		  <?php do { ?>
		    <tr>
		      <td><?php echo $row_tampil['kd_lab']; ?></td>
		      <td><?php echo $row_tampil['no_rm']; ?></td>
		      <td><?php echo $row_tampil['hasil_lab']; ?></td>
		      <td><?php echo $row_tampil['ket']; ?></td>
		      <td>
              <div class='btn-group'>
              <a href="hapuslab.php?kd_lab=<?php echo $row_tampil['kd_lab']; ?>"class="btn btn-mini btn-danger tipsy-kiri-atas" title="Hapus Data Ini"><i class="icon-remove icon-white"></i></a> 
              <a href="formeditlab.php?kd_lab=<?php echo $row_tampil['kd_lab']; ?>" class="btn btn-mini btn-info tipsy-kiri-atas" title='Edit Data ini'> <i class="icon-edit icon-white"></i> </a></div>
              </td>
	      </tr>
